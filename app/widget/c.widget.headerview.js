...
define(['cBase', 'cUICore', 'cWidgetFactory', 'cUtility', 'cSales', 'cHybridFacade'], function (cBase, cUICore, WidgetFactory, cUtlity, cSales, Facade) {
    ...
    */
    ...
    options.hideHandler = function ($super) {
        if (cUtlity.isInApp()) {
            Facade.request({ name: Facade.METHOD_SET_NAVBAR_HIDDEN });
        } else {
            this.hide();
        }
    };
    ...
    options.saveHead = function () {
        ...
        if (obj.citybtn) {
            head.centerButtons.push({ "tagname": "cityChoose", "value": obj.citybtn, "a_icon": "icon_arrowx", "i_icon": "icon_arrowx.png" });
        }
