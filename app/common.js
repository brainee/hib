...
(function () {
	...
	if (document.location.href.indexOf('localhost') > 0 || document.location.href.indexOf('172') > 0) app = 'http://172.16.144.113:5389/webapp/app/';
  if (window.location.hostname == '127.0.0.1' || window.location.hostname == 'svn.ui.sh.ctripcorp.com') app = '/lizard/app/';
