 ...
 */
define(['libs', 'c', 'cBasePageView', buildViewTemplatesPath('ajaxselect.html')], function (libs, c, pageview, html) {
    "use strict";
    ...
    var View = pageview.extend({
        ...
        onLoad: function () {
            ...
            storeinstance.getAttr('showHisName')?this.$('.acityname').html(storeinstance.getAttr('showHisName').name) : '';
