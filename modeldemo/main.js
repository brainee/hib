...
window.PATH = {
  ...
  VIEWS_PATH: 'modeldemo/views/', //页面view目录,helloworld为部署的虚拟目录
  TPL_PATH: 'modeldemo/templates/', //html模板目录
...
require.config({
  ...
  //paths
  paths: {
      'DemoModel': 'modeldemo/models/demomodel',
      'DemoStore': 'modeldemo/models/demostore'
  }
});
