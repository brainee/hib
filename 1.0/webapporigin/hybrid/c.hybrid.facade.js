...
define(['libs', 'CommonStore','cLog'], function(libs, CommonStore,cLog){
  ...
  Facade.METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET = 'METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET';
  Facade.METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET = 'METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET';
  Facade.METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET = 'METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET';
  ...
  var METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET = 'check_ticket_in_samsung_wallet';
  var METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET = 'download_ticket_in_samsung_wallet';
  var METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET = 'show_ticket_in_samsung_wallet';
  ...
  var defaultRegisterHandler = {
    ...
    METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET: function(options) {
      defaultCallback[METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET] = function (params) {
        if (typeof options.callback === 'function') {
          options.callback(params);
        }
      };
    ...
    METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET: function(options) {
      defaultCallback[METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET] = function (params) {
        if (typeof options.callback === 'function') {
          options.callback(params);
        }
      };
    ...
    METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET: function(options) {
      defaultCallback[METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET] = function (params) {
        if (typeof options.callback === 'function') {
          options.callback(params);
        }
      };
  ...
  var defaultHandler = {
    ...
    check_ticket_in_samsung_wallet: function(options) {
      if (typeof defaultCallback[METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET] === 'function') {
        defaultCallback[METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET](options);
      }
    },

    download_ticket_in_samsung_wallet: function(options) {
      if (typeof defaultCallback[METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET] === 'function') {
        defaultCallback[METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET](options);
      }
    },

    show_ticket_in_samsung_wallet: function(options) {
      if (typeof defaultCallback[METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET] === 'function') {
        defaultCallback[METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET](options);
      }
    }
  };
  ...
  Facade.request = function(options){
    ...
    var methods = {
      ...
      METHOD_SEND_H5_PIPE_REQUEST: function (options) {
        ...
        CtripPipe.app_send_H5_pipe_request(options.serviceCode, options.header, options.data, options.sequenceId);
      },

      METHOD_SEND_HTTP_PIPE_REQUEST: function (options) {
        Facade.register({ tagname: Facade.METHOD_SEND_HTTP_PIPE_REQUEST, callback: options.callback });
        CtripPipe.app_send_HTTP_pipe_request(options.target, options.methods, options.header, options.queryData, options.retryInfo);
      },
       ...
       * @param options.callback {function} 检查回调
       * @param options.ticketID {string} ticket id
       * @example
       *   var json_obj = {
       ...
       */
      METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET: function (options) {
        Facade.register({ tagname: Facade.METHOD_CHECK_TICKET_IN_SAMSUNG_WALLET, callback: options.callback });
        CtripSumSungWallet.app_check_ticket_in_samsung_wallet(options.ticketID);
      },

      /**
       * @description 到三星钱包中下载ticket
       * @param options.callback {function} 下载回调
       * @param options.ticketID {string} ticket id
       * @example
       *   var json_obj = {
       ...
       */
      METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET: function (options) {
        Facade.register({ tagname: Facade.METHOD_DOWNLOAD_TICKET_IN_SAMSUNG_WALLET, callback: options.callback });
        CtripSumSungWallet.app_download_ticket_in_samsung_wallet(options.ticketID);
      },

      /**
       * @description 在三星钱包app中查看Ticket
       * @param options.callback {function} 查看回调
       * @param options.ticketID {string} ticket id
       * @example
       *   var json_obj = {
       ...
       */
      METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET: function (options) {
        Facade.register({ tagname: Facade.METHOD_SHOW_TICKET_IN_SAMSUNG_WALLET, callback: options.callback });
        CtripSumSungWallet.app_show_ticket_in_samsung_wallet(options.ticketID);
      }
    };
