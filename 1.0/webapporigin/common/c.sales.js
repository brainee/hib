define(['cBase', 'cStorage', 'libs', 'CommonStore', 'cUtility', 'cModel'], function (cBase, cStorage, libs, CommonStore, cUtility, AbstractModel) {
  var __SALES__ = null;
  ...
  function replaceContent(el) {
    ...
    //$(el[0]).find(MARKLINKCLASS).each(function () {mei
    // fix 新的框架电话失败的bug shbzhang
    $(MARKLINKCLASS).each(function () {
