...
window.PATH = {
  ...
  VIEWS_PATH: 'viewdemo/views/', //页面view目录,helloworld为部署的虚拟目录
  TPLS_PATH: 'viewdemo/templates/', //页面view目录,helloworld为部署的虚拟目录
...
function buildViewTemplatesPath(htmlpath) {
    return 'text!' + window.PATH.TPLS_PATH + htmlpath;
}
