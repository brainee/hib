...
define(['libs', 'cUIHeader', 'cUIAlert', 'cUIWarning', 'cUIHeadWarning', 'cUIWarning404', 'cUIToast', 'cUILoading', 'cUIBubbleLayer', 'cBusinessCommon', 'cUtility'],
  function (libs, cUIHeader, Alert, Warning, HeadWarning, Warning404, Toast, Loading, cUIBubbleLayer, BusinessCommon, util) {
    "use strict";
    ...
    var PageView = Backbone.View.extend({
      ...
      show: function () {
        ...
        this.$el.show();
        //调用onload
        this.onLoad && this.onLoad(this.lastViewId);
        //if (!this.loaded)
        {
