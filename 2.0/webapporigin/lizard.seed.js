...
(function () {
    ...
    Lizard.isHybrid = !!(window.Internal && window.Internal.isInApp || window.LizardLocalroute || is_in_ctrip_app());
    if (Lizard.isHybrid) {
        ...
        */
        if (Lizard.weinre) {
            require.config({
                ...
                baseUrl: "http://" + Lizard.ip + ":5389/" + Lizard.chanal
            })
        }
        require.config({
            shim: {
            ...
            "paths": {
                ...
                "AbstractAPP": Lizard.dir + "c.abstract.app",
                "App": Lizard.dir + "business/c.business.app",
